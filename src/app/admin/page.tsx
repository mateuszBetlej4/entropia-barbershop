...
export default function AdminPage() {
  ...
  // Simple authentication - in a real app, this would use a secure authentication system
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (username === 'admin' && password === 'entropia123') {
      // Store authentication in localStorage
      localStorage.setItem('entropia_admin_auth', 'true');
