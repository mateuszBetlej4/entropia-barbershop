...
export default function BookingPage() {
  // Simplified approach - no iframe, just direct link
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 bg-zinc-900 p-8 rounded-md">
          ...
          <ol className="text-gray-300 space-y-4">
            <li className="flex">
              <span className="bg-purple text-white w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0">1</span>
              <div>
            ...
            <li className="flex">
              <span className="bg-purple text-white w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0">2</span>
              <div>
            ...
            <li className="flex">
              <span className="bg-purple text-white w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0">3</span>
              <div>
            ...
            <li className="flex">
              <span className="bg-purple text-white w-8 h-8 rounded-full flex items-center justify-center mr-4 flex-shrink-0">4</span>
              <div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          {/* Direct booking section instead of iframe */}
          ...
          <div className="mt-8 text-center">
            ...
            <a 
              ...
              className="text-xl font-bold text-purple-light hover:underline transition-colors"
            >
              +48 666 666 666
            </a>
          </div>
