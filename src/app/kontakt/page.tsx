    ...
    <main className="py-16 bg-zinc-950">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="bg-zinc-900 p-8 rounded-md mb-8">
              <div className="flex items-start mb-6">
                <div className="bg-amber-500 p-3 rounded-full text-black mr-4">
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    <a href="tel:+48666666666" className="hover:text-amber-400 transition-colors">+48 666 666 666</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    <a href="mailto:kontakt@entropiabarbershop.pl" className="hover:text-amber-400 transition-colors">kontakt@entropiabarbershop.pl</a>
                  </p>
                </div>
              </div>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-zinc-900 p-4 rounded-full hover:bg-amber-500 transition-colors text-white hover:text-black"
              >
            ...
            <form className="bg-zinc-900 p-8 rounded-md">
              <div className="mb-6">
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-md px-4 py-2 text-white focus:outline-none focus:border-amber-500"
              ...
              <button 
                type="submit"
                className="w-full bg-amber-500 hover:bg-amber-600 text-black font-medium py-3 px-4 rounded-md transition-colors"
              >
                Wyślij wiadomość
              </button>
            </form>
        ...
        <div className="mt-16 text-center">
          ...
          <Link 
            href="/rezerwacja" 
            className="inline-block bg-amber-500 hover:bg-amber-600 text-black font-medium py-3 px-8 rounded-md transition-colors"
          >
            Zarezerwuj wizytę
          </Link>
        </div>
